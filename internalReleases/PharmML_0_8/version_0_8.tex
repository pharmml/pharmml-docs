...
\section{Summary of changes/extensions}
The following table summarises the major changes in version 0.8 described in detail 
in following chapters. We have tried to be exhaustive, please let us know we missed 
anything.
