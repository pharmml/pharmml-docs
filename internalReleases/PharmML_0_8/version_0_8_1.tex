...
This document describes extensions and changes in \pml compared to version 0.8
released in January 2016. The changes so far are visualised in Figure \ref{fig:history}.

\begin{figure}[ht!]
\centering
  \includegraphics[width=170mm]{pics/Timeline-081.pdf}
 \caption{PharmML development history with major/minor releases.}
 \label{fig:history}
\end{figure}

\section{Summary of changes/extensions}
The following table summarises the major changes in version 0.8.1 described in detail 
