...
a quite detailed overview of its content for about 60+ distributions
...
\begin{figure}[ht!]
\centering
  \includegraphics[width=140mm]{pics/GeneralizedPoisson1.pdf}
...
\textbf{type} & & scalar \\
\textbf{symbol} & & $\theta$  \\
\textbf{definition} & & $\theta \in R, \theta > 0$
\end{tabular}
...
\textbf{type} & & scalar \\
\textbf{symbol} & & $\delta$  \\
\textbf{definition} & & $\max(-1,-\theta/4) < \delta < 1$
\end{tabular}
\subsubsection*{Functions}

\smallskip \noindent \hspace{.2cm} \textbf{PMF} 
\begin{equation*}\frac{\theta (\theta+k\delta)^{k-1}\times e^{-\theta - k \delta}}{k!}\end{equation*}
\smallskip \noindent \hspace{.2cm} \textbf{PMF in R}  
\begin{verbatim}(theta*(theta+k*delta)^(k-1) * exp(-theta-k*delta)) / factorial(k)\end{verbatim}
\smallskip \noindent \hspace{.2cm} \textbf{CDF} 
...
\subsubsection*{Characteristics}
\smallskip \noindent \hspace{.2cm} \textbf{Mean} 
\begin{equation*}\frac{\theta}{1 -\delta}\end{equation*}
\smallskip \noindent \hspace{.2cm} \textbf{Variance} 
\begin{equation*}\frac{\theta}{(1 -\delta)^3}\end{equation*}
\smallskip
\section*{Geometric1} 
...
\smallskip \noindent \hspace{.2cm} \textbf{CDF} 
\begin{equation*}1 - I_{1-p}(k+1,r)\end{equation*}
\smallskip \noindent \hspace{.2cm} \textbf{CDF in R} 
\begin{verbatim}1 - Rbeta(1-p, k+1, r, lower = T)\end{verbatim}
\smallskip
\subsubsection*{Characteristics}
\smallskip \noindent \hspace{.2cm} \textbf{Mean} 
