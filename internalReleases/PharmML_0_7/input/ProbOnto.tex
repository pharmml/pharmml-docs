...
%\smallskip\section*{InverseBinomial} 
%
%  \bigskip 
%
%\begin{tabular}{p{2cm}cl}
...
%\begin{figure}[ht!]
%\centering
%  \includegraphics[width=70mm]{pics/NegativeBinomial2.pdf}
...
%\begin{figure}[ht!]
%\centering
%  \includegraphics[width=70mm]{pics/ZeroInflatedNegativeBinomial.pdf}
...
%\begin{figure}[ht!]
%\centering
%  \includegraphics[width=70mm]{pics/ZeroInflatedPoisson.pdf}
...
%\smallskip \noindent \hspace{.2cm} \textbf{Variance} 
%\begin{equation*}Var([x=i]) = p_i (1-p_i) \\ Cov([x=i],[x=j]) = - p_i p_j~~(i\neq j)\end{equation*}
%\smallskip
...
%\smallskip \noindent \hspace{.2cm} \textbf{Variance} 
%\begin{equation*}Var[X_i] = \frac{\alpha_i (\alpha_0-\alpha_i)}{\alpha_0^2 (\alpha_0+1)} \\ \text{where} \quad \alpha_0 = \sum_{i=1}^K\alpha_i \\ Cov[X_i,X_j] = \frac{- \alpha_i \alpha_j}{\alpha_0^2 (\alpha_0+1)}~~(i\neq j)\end{equation*}
%\smallskip
%%\section*{Code name} 
%%
%%  \bigskip 
%%
%%\begin{tabular}{p{2cm}cl}
%%\textbf{name} & & Distribution Name (ID: 0000496)\\ 
%% 
%%\textbf{type} & & continuous \\ 
%%
%%\textbf{variate} & & $Variate Symbol$, Variate type \\ 
%%
%%\textbf{support} & & $Support definition$
%%\end{tabular}
%%
%%\begin{figure}[ht!]
%%\centering
%%  \includegraphics[width=140mm]{pics/Code name.pdf}
%% \caption{Code name distribution plotted using the provided R code.}
%% \label{fig:Code name}
%%\end{figure}
%%
%%\subsubsection*{Parameter: parameter code name}
%%
%%\noindent\begin{tabular}{p{2cm}cl}
%%\textbf{name} & & parameter name \\
%%\textbf{type} & & parameter type \\
%%\textbf{symbol} & & $parameter symbol$  \\
%%\textbf{definition} & & $parameter definition$
%%\end{tabular}
%%\subsubsection*{Parameter: parameter code name}
%%
%%\noindent\begin{tabular}{p{2cm}cl}
...
%%
%%\smallskip \noindent \hspace{.2cm} \textbf{PDF} 
%%\begin{equation*}PDF\end{equation*}
%%\smallskip \noindent \hspace{.2cm} \textbf{PDF in R}  
%%\begin{verbatim}PDF R code\end{verbatim}
%%\smallskip \noindent \hspace{.2cm} \textbf{CDF} 
%%\begin{equation*}CDF\end{equation*}
%%\smallskip \noindent \hspace{.2cm} \textbf{CDF in R} 
%%\begin{verbatim}CDF R code\end{verbatim}
%%\smallskip
%%\subsubsection*{Characteristics}
%%\smallskip \noindent \hspace{.2cm} \textbf{Mean} 
%%\begin{equation*}Mean\end{equation*}
%%\smallskip \noindent \hspace{.2cm} \textbf{Median} 
%%\begin{equation*}Median\end{equation*}
%%\smallskip \noindent \hspace{.2cm} \textbf{Mode} 
%%\begin{equation*}Mode\end{equation*}
%%\smallskip \noindent \hspace{.2cm} \textbf{Variance} 
%%\begin{equation*}Variance\end{equation*}
%%\smallskip
%\section*{Exponential} 
%
%  \bigskip 
...
%\smallskip \noindent \hspace{.2cm} \textbf{Median} 
%\begin{equation*}No simple closed form\end{equation*}
%\smallskip \noindent \hspace{.2cm} \textbf{Mode} 
