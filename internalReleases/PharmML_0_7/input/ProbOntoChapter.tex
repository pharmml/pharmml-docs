...
\begin{align}
P(k;\lambda,\tau) = \frac{\Gamma(k+\frac{1}{\tau})}{k!\; \Gamma(\frac{1}{\tau})} \Big(\frac{1}{1+\tau \lambda} \Big)^{\frac{1}{\tau}} \Big(\frac{\lambda}{\frac{1}{\tau} + \lambda} \Big)^{k},\quad k\in \{0,1,2,\dots \}  \nonumber
\end{align}

\item
Negative Binomial 3\,($\mu$, $k$) %with $\lambda$ -- \emph{Poisson intensity} and $\tau$ -- \emph{over-dispersion},
\begin{align}
P(k;\mu,\phi) = \binom {k+r-1}k \Big(\frac{\mu}{\mu + r} \Big)^{r} \Big(\frac{r}{\mu + r} \Big)^{k},\quad k\in \{0,1,2,\dots \}  \nonumber
\end{align}
\end{itemize}
...
\end{align}
To see then the slightly complicated relationships between $cv$ and $\sigma_g$
on the natural scale one has to recall the formula $\sigma_g = exp(\sigma)$, see the 
...
\multicolumn{1}{c}{on the natural scale (NS)} 	&						& \multicolumn{1}{c}{log-transformed scale (LS)} \\
   \hline
  \hline
  \multicolumn{3}{c}{\Gape[.3cm][.1cm]{}$LN1(\boldsymbol\mu,\boldsymbol\sigma)$} \\
...
%									& of variation				& \\
  \hline
  \multicolumn{3}{c}{\Gape[.3cm][.1cm]{}$LN2(\boldsymbol\mu,\boldsymbol {v})$} \\
...
%									& of variation				& \\
  \hline
  \multicolumn{3}{c}{\Gape[.3cm][.1cm]{}$LN3P(\boldsymbol m,\boldsymbol \sigma)$}\\ 
...
% 									&  of variation				&  \\
  \hline
   \multicolumn{3}{c}{\Gape[.3cm][.1cm]{}$LN4(\boldsymbol m,\boldsymbol {cv})$} \\
...
% 									& deviation  				& 	\\ [.25ex]
 ...
 ${\boldsymbol {cv}}$					& Coefficient of variation		& $\sqrt{\log(cv^2 + 1)}/\log( m)$ \\ [.5EX]
  \hline
  \multicolumn{3}{c}{\Gape[.3cm][.1cm]{}$LN5(\boldsymbol\mu,\boldsymbol \tau)$}\\
...
$\sqrt{e^{\frac{1}{\tau}}-1}$							& Coefficient of variation		& $\sqrt{1/\tau} / \mu$ \\ [0EX]
  ...
  \hline
  \multicolumn{3}{c}{\Gape[.3cm][.1cm]{}$LN6(\boldsymbol m,\boldsymbol {\sigma_g})$}\\
