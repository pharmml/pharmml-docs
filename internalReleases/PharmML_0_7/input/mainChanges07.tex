...
described in the ProbOnto spec \cite{ProbOnto:2015a}, in that it doesn't allow 
...
\section{winBUGS \emph{Oranges} example 1}
...
\centering
 ...
 (B) the source of the study design and data (Monolix/NONMEM dataset or \xelem{TrialDesign}) 
 ...
 in the \xelem{TrialDesign} section while the last section, \xelem{ModellingSteps}, 
