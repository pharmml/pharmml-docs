...
%The paper by 1920 by Greenwood \& Woods, \cite{greenwood1920inquiry},
%describes the compounding of the Poisson distribution with gamma distribution
%leading to another commonly used formulation of NB and its applications.
...
%Consul,Jain 1973
%Greenwood and Yule (1920) assumed that X in the Poisson distribution%followed the gamma distribution
