...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\input{input/mainChangesChapters}


\appendix
\chapter{Generalised Negative Binomial Distribution}
\section{Introduction}
The \emph{negative binomial} distribution, NB, was first proposed almost 
100 years ago in 1919 by Greenwood \& Woods, \cite{greenwood1920inquiry}, 
...
The PMF of the GNB is defined for $0<\alpha<1$ and $|\alpha \beta| < 1$ and reads in Jain \& Consul
paper
\begin{align*}
b_{\beta}(x,n,\alpha) &= 
...
\section{GNB($\alpha$,$\beta$) $\rightarrow$ NB($r$,$p$)}
