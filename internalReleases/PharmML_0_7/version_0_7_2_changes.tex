...
\hline
Dataset's \xatt{columnType}	& Number of values allowed		& {\color{red} \scshape{new}} \emph{randEffect\_stdev}, \emph{randEffect\_var}, \\
section \ref{sec:otherChanges072}	&						& \emph{randEffect\_cov} and \emph{randEffect\_corr} \\
						&							& to support identification of random effects \\
						&							& stored in SO tables\\
\hline
