...
\lstdefinelanguage{XML}
{
  ...
  referenceLevel,ref,referenceCategory,base,tool,distFct } % list your attributes here
}
...
%Covariate model is barely cove1.2 so far. See also \cite{Keizer:2011aa}. Missing are following features:\\
