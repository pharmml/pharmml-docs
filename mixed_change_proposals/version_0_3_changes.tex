...
Using NONMEM datasets has consequences on the content of the PharmML document in that
...
\\
    \hline
\end{tabular}
\caption{Comparison of model structures encoded using \xelem{TrialDesign} (left) versus models using NONMEM format dataset (right).}
